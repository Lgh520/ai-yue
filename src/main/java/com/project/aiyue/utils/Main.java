...
//        String text = document.select("#content > div.grid-16-8 > div.article > dic.indent > div.subjectwrap > div.subject >  div:nth-child(1)").text();
        Elements text = document.select("#content > div.grid-16-8 > div.article > div.indent > div.subjectwrap > div.subject >div:nth-child(2)");
        int count = 1;
        for (org.jsoup.nodes.Element element:text
             ) {
...
//            Elements select = text.select("span");
//            org.jsoup.nodes.Element element1 = select.get(1);
//            Elements element1_span = element1.select("span");
//            String author = element1_span.text();
//            String authorName = element1_span.select("a").text();
